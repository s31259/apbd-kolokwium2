    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestLocation1", "TestRace1" },
                    { 2, new DateTime(2025, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestLocation2", "TestRace2" },
                    { 3, new DateTime(2025, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), "TestLocation3", "TestRace3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "TestFirstName1", "TestLastName1" },
                    { 2, "TestFirstName2", "TestLastName2" },
                    { 3, "TestFirstName3", "TestLastName3" }
                });
